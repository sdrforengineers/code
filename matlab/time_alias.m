...
%legend('Digital Sampling', 'Digital Samples', 'Analog Input Signal', 'Location', 'eastoutside');
hold off;
...
%legend('Digital Sampling', 'Digital Samples', 'Digital Reconstruction', 'Location', 'eastoutside');
xlabel('Digital Samples');ylabel('Amplitude');
xlim([0 N-1])
hold off;
